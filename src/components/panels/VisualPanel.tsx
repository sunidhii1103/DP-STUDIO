  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', height: '100%' }}>
      ...
      <div className="panel" style={{ flexShrink: 0 }}>
        <h3 style={{ marginTop: 0, color: 'var(--color-accent-secondary)', textTransform: 'capitalize', fontSize: '1.1rem', marginBottom: '1rem' }}>
          {step.algorithm === 'knapsack' && step.approach === 'memoization' 
            ? `Computing State (${step.activeIndices.i}, ${step.activeIndices.j})` 
            : `Step ${step.index + 1} — ${step.operation}`}
        </h3>
